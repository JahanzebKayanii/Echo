    ...
    response = client.messages.create(
        ...
        messages=[{
            ...
            "content": (
                ...
                "CRITICAL: If a speaker merely MENTIONS someone's name "
                "(e.g. 'Paul called this meeting', 'I spoke with Sarah') "
                "that does NOT mean the speaker IS that person — they are talking ABOUT someone else.\n"
                "Only use real person names — not roles like 'Narrator', 'Interviewer', or 'Host'.\n"
                "When in doubt, leave the speaker out.\n\n"
